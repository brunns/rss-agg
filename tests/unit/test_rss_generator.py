...
def test_builds_rss_structure():
    ...
    # When
    actual = generator.generate_new_rss_feed([item], URL("https://example.com"), 1)
...
def test_removes_dc_date_elements():
    ...
    # When
    actual_xml_str = generator.generate_new_rss_feed([item], URL("https://example.com"), 1)
...
def test_sorts_items_by_date_descending():
    ...
    # When
    actual = generator.generate_new_rss_feed([old_item, new_item], URL("https://example.com"), 10)
