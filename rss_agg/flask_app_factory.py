...
def build_config() -> dict[str, Any]:
    return {
        ...
        "max_keepalive_connections": int(os.environ.get("MAX_CONNECTIONS", "16")),
        "keepalive_expiry": int(os.environ.get("MAX_CONNECTIONS", "5")),
        "retries": int(os.environ.get("MAX_CONNECTIONS", "3")),
